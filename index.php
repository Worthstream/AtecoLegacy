...
<div id='boxAteco'>
	...
	<section id='search'>
		...
		<input id='autoEncoding' type='text' class='autoEncoding' placeholder='Descrizione attività'></input>
			...
			<span class='description'>Inserisci una descrizione sintetica dell'attività economica <a id='faq'>(suggerimenti per la ricerca)</a> e trova il codice corrispondente</span>
